...
public final class PopupMenuCreatorMouseAdapter extends MouseAdapter {
    ...
    public void mousePressed(final MouseEvent aEvent) {
        ...
        final TreePath selectedPath = sourceTree.getClosestPathForLocation(aEvent
                .getX(), aEvent.getY());
    ...
    private void createPopupMenu(final MouseEvent aEvent) {
            ...
            // containers?
            if(selectedNode == null || selectedNode.equals(selectedNode.getOwnerDocument().getDocumentElement())) {
            ...
            // there isn't.
                ...
                { // Seperate the scopes for the two menu items.
                    ...
                    editValueItem.addActionListener(new EditValueClicked(sourceTree, selectedNode));
                ...
                }
                {
                    ...
                    editNameItem.addActionListener(new EditNameClicked(selectedNode, sourceTree));
                ...
                addMenuItem.addActionListener(new AddItemClicked(sourceTree, selectedNode));
    ...
    /**
     * Action listeners which is activated when the user
     * selects the Add item menu button. Activates the interface
     * elements to add an item and add the item to the tree.
     * @author Josh Lurz
     */
	private final class AddItemClicked implements ActionListener {
        ...
        /**
         * Constructor
         * @param aTree The tree which the action listener will modify.
         * @param aNode The node selected in the tree.
         */
        public AddItemClicked(JTree aTree, Node aNode) {
            super();
            mTree = aTree;
            mNode = aNode;
        }
    ...
    /**
     * Action listeners which is activated when the user
     * selects the Edit name menu button. Activates the interface
     * elements to edit a name and update the name in the tree.
     * @author Josh Lurz
     */
    private final class EditNameClicked implements ActionListener {
        ...
        public void actionPerformed(final ActionEvent aLocalEvent) {
        	...
        	if (newName != null) {
        		...
        		// the node.
        		DOMUtils
        				.setNameAttrValue(mNode, newName);
    ...
    /**
     * Action listeners which is activated when the user
     * selects the Edit value menu button. Activates the interface
     * elements to edit a value and update the tree.
     * @author Josh Lurz
     */
    private final class EditValueClicked implements ActionListener {
         ...
         * @param aNode The node selected in the tree.
         */
        public EditValueClicked(JTree aTree, Node aNode) {
            super();
            mTree = aTree;
            mNode = aNode;
        }
        ...
        public void actionPerformed(final ActionEvent aLocalEvent) {
        	...
        	final String currentValue = mNode
        			.getTextContent();
            final String newValue = (String) JOptionPane
        			.showInputDialog((Component) aLocalEvent
        					.getSource(), message, title,
        					JOptionPane.QUESTION_MESSAGE, null,
        					null, currentValue);
