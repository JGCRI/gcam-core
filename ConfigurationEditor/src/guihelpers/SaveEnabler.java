...
/**
 * Listener which enables a save component when the document the component
 * would save is modified for the first time.
 * @author Josh Lurz
 *
 */
public final class SaveEnabler implements PropertyChangeListener {
	...
	/**
	 * Constructor
	 * @param aComponent Component to disable or enable.
	 */
	...
	/**
	 * Method called when a property change is received from the editor.
	 * The method checks if this is a document modified event or document replaced event,
	 * if it is a document modified event it enables the component if it was not 
	 * already enabled, if it is a document-replaced event it disables the component.
