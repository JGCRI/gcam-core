...
module_energy_LA1231.elec_tech<- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    tibble(technology=GAS_TECH,supplysector = "electricity")->Gas_tech_elec
    ...
    # Rename efficiecy as value for final output in long format
    L1231.eff_R_elec_F_tech_Yh %>%
      rename(value=efficiency) -> L1231.eff_R_elec_F_tech_Yh

    # Combine output with technologies modeled by output only (e.g. nuclear, hydro, renewables)
