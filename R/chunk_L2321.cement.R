...
FILE = "socioeconomics/A321.inc_elas_output",
 ...
 "L102.pcgdp_thous90USD_Scen_R_Y"))
    ...
    return(c(XML = "L2321.SectorLogitTables[[ curr_table ]]$data",
XML = "L2321.Supplysector_cement",
XML = "L2321.FinalEnergyKeyword_cement",
XML = "L2321.SubsectorLogitTables[[ curr_table ]]$data",
XML = "L2321.SubsectorLogit_cement",
XML = "L2321.SubsectorShrwt_cement",
XML = "L2321.SubsectorShrwtFllt_cement",
XML = "L2321.SubsectorInterp_cement",
XML = "L2321.SubsectorInterpTo_cement",
XML = "L2321.StubTech_cement",
XML = "L2321.GlobalTechShrwt_cement",
XML = "L2321.GlobalTechCoef_cement",
XML = "L2321.GlobalTechCost_cement",
XML = "L2321.GlobalTechCapture_cement",
XML = "L2321.StubTechProd_cement",
XML = "L2321.StubTechCalInput_cement_heat",
XML = "L2321.StubTechCoef_cement",
XML = "L2321.PerCapitaBased_cement",
XML = "L2321.BaseService_cement",
XML = "L2321.PriceElasticity_cement",
XML = "object"))
 ...
 add_legacy_name("L2321.SectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L2321.SectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
...
tibble() %>%
 ...
 add_comments("comments describing how data generated") %>%
 add_comments("can be multiple lines") %>%
 add_legacy_name("L2321.SubsectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L2321.SubsectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
 ...
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   object
    ...
    return_data(L2321.SectorLogitTables[[ curr_table ]]$data, L2321.Supplysector_cement, L2321.FinalEnergyKeyword_cement, L2321.SubsectorLogitTables[[ curr_table ]]$data, L2321.SubsectorLogit_cement, L2321.SubsectorShrwt_cement, L2321.SubsectorShrwtFllt_cement, L2321.SubsectorInterp_cement, L2321.SubsectorInterpTo_cement, L2321.StubTech_cement, L2321.GlobalTechShrwt_cement, L2321.GlobalTechCoef_cement, L2321.GlobalTechCost_cement, L2321.GlobalTechCapture_cement, L2321.StubTechProd_cement, L2321.StubTechCalInput_cement_heat, L2321.StubTechCoef_cement, L2321.PerCapitaBased_cement, L2321.BaseService_cement, L2321.PriceElasticity_cement, object)
  } else {
