...
FILE = "energy/A322.globaltech_retirement",
 ...
 "L142.ag_Fert_NetExp_MtN_R_Y"))
    ...
    return(c(XML = "L2322.SectorLogitTables[[ curr_table ]]$data",
XML = "L2322.Supplysector_Fert",
XML = "L2322.FinalEnergyKeyword_Fert",
XML = "L2322.SubsectorLogitTables[[ curr_table ]]$data",
XML = "L2322.SubsectorLogit_Fert",
XML = "L2322.SubsectorShrwt_Fert",
XML = "L2322.SubsectorShrwtFllt_Fert",
XML = "L2322.SubsectorInterp_Fert",
XML = "L2322.SubsectorInterpTo_Fert",
XML = "L2322.StubTech_Fert",
XML = "L2322.GlobalTechShrwt_Fert",
XML = "L2322.GlobalTechCoef_Fert",
XML = "L2322.GlobalTechCost_Fert",
XML = "L2322.GlobalTechCapture_Fert",
XML = "L2322.GlobalTechShutdown_Fert",
XML = "L2322.GlobalTechSCurve_Fert",
XML = "L2322.GlobalTechLifetime_Fert",
XML = "L2322.GlobalTechProfitShutdown_Fert",
XML = "L2322.StubTechProd_Fert",
XML = "L2322.StubTechCoef_Fert",
XML = "L2322.StubTechFixOut_Fert_imp",
XML = "L2322.StubTechFixOut_Fert_exp",
XML = "L2322.PerCapitaBased_Fert",
XML = "L2322.BaseService_Fert"))
 ...
 add_legacy_name("L2322.SectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L2322.SectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
...
tibble() %>%
 ...
 add_comments("comments describing how data generated") %>%
 add_comments("can be multiple lines") %>%
 add_legacy_name("L2322.SubsectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L2322.SubsectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
 ...
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L2322.BaseService_Fert
    ...
    return_data(L2322.SectorLogitTables[[ curr_table ]]$data, L2322.Supplysector_Fert, L2322.FinalEnergyKeyword_Fert, L2322.SubsectorLogitTables[[ curr_table ]]$data, L2322.SubsectorLogit_Fert, L2322.SubsectorShrwt_Fert, L2322.SubsectorShrwtFllt_Fert, L2322.SubsectorInterp_Fert, L2322.SubsectorInterpTo_Fert, L2322.StubTech_Fert, L2322.GlobalTechShrwt_Fert, L2322.GlobalTechCoef_Fert, L2322.GlobalTechCost_Fert, L2322.GlobalTechCapture_Fert, L2322.GlobalTechShutdown_Fert, L2322.GlobalTechSCurve_Fert, L2322.GlobalTechLifetime_Fert, L2322.GlobalTechProfitShutdown_Fert, L2322.StubTechProd_Fert, L2322.StubTechCoef_Fert, L2322.StubTechFixOut_Fert_imp, L2322.StubTechFixOut_Fert_exp, L2322.PerCapitaBased_Fert, L2322.BaseService_Fert)
  } else {
