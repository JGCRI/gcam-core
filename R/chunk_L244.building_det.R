...
#' the generated outputs: \code{L244.SubregionalShares}, \code{L244.PriceExp_IntGains}, \code{L244.Floorspace}, \code{L244.DemandFunction_serv}, \code{L244.DemandFunction_flsp}, \code{L244.Satiation_flsp}, \code{L244.SatiationAdder}, \code{L244.ThermalBaseService}, \code{L244.GenericBaseService}, \code{object}, \code{L244.ThermalServiceSatiation}, \code{L244.GenericServiceSatiation}, \code{L244.Intgains_scalar}, \code{L244.ShellConductance_bld}, \code{L244.SectorLogitTables[[ curr_table ]]$data}, \code{L244.Supplysector_bld}, \code{L244.FinalEnergyKeyword_bld}, \code{L244.SubsectorShrwt_bld}, \code{L244.SubsectorShrwtFllt_bld}, \code{L244.SubsectorInterp_bld}, \code{L244.SubsectorInterpTo_bld}, \code{L244.SubsectorLogitTables[[ curr_table ]]$data}, \code{L244.SubsectorLogit_bld}, \code{L244.FuelPrefElast_bld}, \code{L244.StubTech_bld}, \code{L244.StubTechEff_bld}, \code{L244.StubTechCalInput_bld}, \code{L244.StubTechIntGainOutputRatio}, \code{L244.GlobalTechShrwt_bld}, \code{L244.GlobalTechCost_bld}, \code{L244.DeleteThermalService}, \code{L244.DeleteGenericService}, \code{L244.Satiation_flsp_SSP1}, \code{L244.SatiationAdder_SSP1}, \code{L244.GenericServiceSatiation_SSP1}, \code{L244.FuelPrefElast_bld_SSP15}, \code{L244.DeleteThermalService}, \code{L244.Satiation_flsp_SSP2}, \code{L244.SatiationAdder_SSP2}, \code{L244.GenericServiceSatiation_SSP2}, \code{L244.Satiation_flsp_SSP3}, \code{L244.SatiationAdder_SSP3}, \code{L244.GenericServiceSatiation_SSP3}, \code{L244.FuelPrefElast_bld_SSP3}, \code{L244.DeleteThermalService}, \code{L244.Satiation_flsp_SSP4}, \code{L244.SatiationAdder_SSP4}, \code{L244.GenericServiceSatiation_SSP4}, \code{L244.FuelPrefElast_bld_SSP4}, \code{L244.DeleteThermalService}, \code{L244.Satiation_flsp_SSP5}, \code{L244.SatiationAdder_SSP5}, \code{L244.GenericServiceSatiation_SSP5}, \code{L244.FuelPrefElast_bld_SSP15}, \code{L244.DeleteThermalService}. The corresponding file in the
...
#' @export
module_energy_L244.building_det_DISABLED <- function(command, ...) {
...
FILE = "energy/A44.demand_satiation_mult_SSPs",
 ...
 "L102.pcgdp_thous90USD_Scen_R_Y"))
    ...
    return(c(XML = "L244.SubregionalShares",
...
XML = "L244.SectorLogitTables[[ curr_table ]]$data",
...
XML = "L244.SubsectorLogitTables[[ curr_table ]]$data",
XML = "L244.SubsectorLogit_bld",
XML = "L244.FuelPrefElast_bld",
XML = "L244.StubTech_bld",
XML = "L244.StubTechEff_bld",
XML = "L244.StubTechCalInput_bld",
XML = "L244.StubTechIntGainOutputRatio",
XML = "L244.GlobalTechShrwt_bld",
XML = "L244.GlobalTechCost_bld",
XML = "L244.DeleteThermalService",
XML = "L244.DeleteGenericService",
XML = "L244.Satiation_flsp_SSP1",
XML = "L244.SatiationAdder_SSP1",
XML = "L244.GenericServiceSatiation_SSP1",
XML = "L244.FuelPrefElast_bld_SSP15",
XML = "L244.DeleteThermalService",
XML = "L244.Satiation_flsp_SSP2",
XML = "L244.SatiationAdder_SSP2",
XML = "L244.GenericServiceSatiation_SSP2",
XML = "L244.Satiation_flsp_SSP3",
XML = "L244.SatiationAdder_SSP3",
XML = "L244.GenericServiceSatiation_SSP3",
XML = "L244.FuelPrefElast_bld_SSP3",
XML = "L244.DeleteThermalService",
XML = "L244.Satiation_flsp_SSP4",
XML = "L244.SatiationAdder_SSP4",
XML = "L244.GenericServiceSatiation_SSP4",
XML = "L244.FuelPrefElast_bld_SSP4",
XML = "L244.DeleteThermalService",
XML = "L244.Satiation_flsp_SSP5",
XML = "L244.SatiationAdder_SSP5",
XML = "L244.GenericServiceSatiation_SSP5",
XML = "L244.FuelPrefElast_bld_SSP15",
XML = "L244.DeleteThermalService"))
...
tibble() %>%
 ...
 add_comments("comments describing how data generated") %>%
 add_comments("can be multiple lines") %>%
 add_legacy_name("L244.SectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L244.SectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
...
tibble() %>%
 ...
 add_comments("comments describing how data generated") %>%
 add_comments("can be multiple lines") %>%
 add_legacy_name("L244.SubsectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L244.SubsectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
 ...
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L244.DeleteThermalService
    ...
    return_data(L244.SubregionalShares, L244.PriceExp_IntGains, L244.Floorspace, L244.DemandFunction_serv, L244.DemandFunction_flsp, L244.Satiation_flsp, L244.SatiationAdder, L244.ThermalBaseService, L244.GenericBaseService, object, L244.ThermalServiceSatiation, L244.GenericServiceSatiation, L244.Intgains_scalar, L244.ShellConductance_bld, L244.SectorLogitTables[[ curr_table ]]$data, L244.Supplysector_bld, L244.FinalEnergyKeyword_bld, L244.SubsectorShrwt_bld, L244.SubsectorShrwtFllt_bld, L244.SubsectorInterp_bld, L244.SubsectorInterpTo_bld, L244.SubsectorLogitTables[[ curr_table ]]$data, L244.SubsectorLogit_bld, L244.FuelPrefElast_bld, L244.StubTech_bld, L244.StubTechEff_bld, L244.StubTechCalInput_bld, L244.StubTechIntGainOutputRatio, L244.GlobalTechShrwt_bld, L244.GlobalTechCost_bld, L244.DeleteThermalService, L244.DeleteGenericService, L244.Satiation_flsp_SSP1, L244.SatiationAdder_SSP1, L244.GenericServiceSatiation_SSP1, L244.FuelPrefElast_bld_SSP15, L244.DeleteThermalService, L244.Satiation_flsp_SSP2, L244.SatiationAdder_SSP2, L244.GenericServiceSatiation_SSP2, L244.Satiation_flsp_SSP3, L244.SatiationAdder_SSP3, L244.GenericServiceSatiation_SSP3, L244.FuelPrefElast_bld_SSP3, L244.DeleteThermalService, L244.Satiation_flsp_SSP4, L244.SatiationAdder_SSP4, L244.GenericServiceSatiation_SSP4, L244.FuelPrefElast_bld_SSP4, L244.DeleteThermalService, L244.Satiation_flsp_SSP5, L244.SatiationAdder_SSP5, L244.GenericServiceSatiation_SSP5, L244.FuelPrefElast_bld_SSP15, L244.DeleteThermalService)
  } else {
