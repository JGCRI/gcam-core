...
module_aglu_L2231.land_input_3_irr_DISABLED <- function(command, ...) {
 ...
 "L223.LN3_MgdCarbon_noncrop"))
    ...
    return(c(XML = "L2231.LN3_LogitTables[[ curr_table_name ]]",
XML = "L2231.LN3_Logit",
XML = "L2231.LN3_HistUnmgdAllocation",
XML = "L2231.LN3_UnmgdAllocation",
XML = "L2231.NodeEquiv",
XML = "L2231.LN3_NoEmissCarbon",
XML = "L2231.LN3_NodeCarbon",
XML = "L2231.LN3_HistMgdAllocation_noncrop",
XML = "L2231.LN3_MgdAllocation_noncrop",
XML = "L2231.LN3_UnmgdCarbon",
XML = "L2231.LN3_MgdCarbon_noncrop"))
