...
module_emissions_L2521.MACC_IRR_DISABLED <- function(command, ...) {
 ...
 "L252.MAC_an"))
    ...
    return(c(XML = "L2521.AgMAC",
XML = "L2521.MAC_an",
XML = "L2521.MAC_Ag_TC_SSP1",
XML = "L2521.MAC_An_TC_SSP1",
XML = "L2521.MAC_Ag_TC_SSP2",
XML = "L2521.MAC_An_TC_SSP2",
XML = "L2521.MAC_Ag_TC_SSP5",
XML = "L2521.MAC_An_TC_SSP5"))
