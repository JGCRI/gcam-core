...
FILE = "energy/A22.globaltech_cost_low  # Note: Low indicates low tech. Costs are actually higher than core.",
...
FILE = "energy/A22.globaltech_retirement",
 ...
 "L122.IO_R_oilrefining_F_Yh"))
    ...
    return(c(XML = "L222.SectorLogitTables[[ curr_table ]]$data",
XML = "L222.Supplysector_en",
XML = "L222.SubsectorLogitTables[[ curr_table ]]$data",
XML = "L222.SubsectorLogit_en",
XML = "L222.SubsectorShrwt_en",
XML = "L222.SubsectorShrwtFllt_en",
XML = "L222.SubsectorInterp_en",
XML = "L222.SubsectorInterpTo_en",
XML = "L222.StubTech_en",
XML = "L222.GlobalTechInterp_en",
XML = "L222.GlobalTechCoef_en",
XML = "L222.GlobalTechCost_en",
XML = "L222.GlobalTechShrwt_en",
XML = "L222.GlobalTechCapture_en",
XML = "L222.GlobalTechShutdown_en",
XML = "L222.GlobalTechSCurve_en",
XML = "L222.GlobalTechLifetime_en",
XML = "L222.GlobalTechProfitShutdown_en",
XML = "L222.StubTechProd_gasproc",
XML = "L222.StubTechProd_refining",
XML = "L222.StubTechCoef_refining",
XML = "L222.GlobalTechCost_low_en"))
  ...
  A22.globaltech_cost_low  # Note: Low indicates low tech. Costs are actually higher than core. <- get_data(all_data, "energy/A22.globaltech_cost_low  # Note: Low indicates low tech. Costs are actually higher than core.")
 ...
 add_legacy_name("L222.SectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L222.SectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
...
tibble() %>%
 ...
 add_comments("comments describing how data generated") %>%
 add_comments("can be multiple lines") %>%
 add_legacy_name("L222.SubsectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L222.SubsectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
 ...
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L222.GlobalTechCost_low_en
    ...
    return_data(L222.SectorLogitTables[[ curr_table ]]$data, L222.Supplysector_en, L222.SubsectorLogitTables[[ curr_table ]]$data, L222.SubsectorLogit_en, L222.SubsectorShrwt_en, L222.SubsectorShrwtFllt_en, L222.SubsectorInterp_en, L222.SubsectorInterpTo_en, L222.StubTech_en, L222.GlobalTechInterp_en, L222.GlobalTechCoef_en, L222.GlobalTechCost_en, L222.GlobalTechShrwt_en, L222.GlobalTechCapture_en, L222.GlobalTechShutdown_en, L222.GlobalTechSCurve_en, L222.GlobalTechLifetime_en, L222.GlobalTechProfitShutdown_en, L222.StubTechProd_gasproc, L222.StubTechProd_refining, L222.StubTechCoef_refining, L222.GlobalTechCost_low_en)
  } else {
