...
module_aglu_L2041.resbio_input_irr_DISABLED <- function(command, ...) {
 ...
 "L204.AgResBioCurve_ag"))
    ...
    return(c(XML = "L2041.AgResBio_For",
XML = "L2041.GlobalResBio_Mill",
XML = "L2041.AgResBio_ag_irr",
XML = "L2041.AgResBioCurve_For",
XML = "L2041.StubResBioCurve_Mill",
XML = "L2041.AgResBioCurve_ag_irr"))
