...
FILE = "energy/A23.globaltech_eff",
 ...
 "L126.out_EJ_state_td_elec"))
    ...
    return(c(XML = "L223.DeleteSubsector_USAelec",
XML = "L223.SectorNodeEquiv",
XML = "L223.TechNodeEquiv",
XML = "L223.PassThroughSector_elec",
XML = "L223.PassThroughTech_elec_FERC",
XML = "object",
XML = "L223.SectorLogitTables_USAelec[[ curr_table ]]$data",
XML = "L223.Supplysector_USAelec",
XML = "L223.SubsectorShrwtFllt_USAelec",
XML = "L223.SubsectorInterp_USAelec",
XML = "L223.SubsectorLogitTables_USAelec[[ curr_table ]]$data",
XML = "L223.SubsectorLogit_USAelec",
XML = "L223.TechShrwt_USAelec",
XML = "L223.TechCoef_USAelec",
XML = "L223.Production_USAelec",
XML = "L223.SectorLogitTables_elec_FERC[[ curr_table ]]$data",
XML = "L223.Supplysector_elec_FERC",
XML = "L223.SubsectorShrwtFllt_elec_FERC",
XML = "L223.SubsectorInterp_elec_FERC",
XML = "L223.SubsectorLogitTables_elec_FERC[[ curr_table ]]$data",
XML = "L223.SubsectorLogit_elec_FERC",
XML = "L223.TechShrwt_elec_FERC",
XML = "L223.TechCoef_elec_FERC",
XML = "L223.Production_elec_FERC",
XML = "L223.InterestRate_FERC",
XML = "L223.Pop_FERC",
XML = "L223.BaseGDP_FERC",
XML = "L223.LaborForceFillout_FERC",
XML = "L223.SubsectorShrwt_nuc_USA",
XML = "L223.StubTechFixOut_elec_USA",
XML = "L223.StubTechFixOut_hydro_USA",
XML = "L223.StubTechProd_elec_USA",
XML = "L223.StubTechMarket_elec_USA",
XML = "L223.StubTechMarket_backup_USA",
XML = "L223.StubTechElecMarket_backup_USA",
XML = "L223.StubTechCapFactor_elec_wind_USA",
XML = "L223.StubTechCapFactor_elec_solar_USA"))
...
tibble() %>%
 ...
 add_comments("comments describing how data generated") %>%
 add_comments("can be multiple lines") %>%
 add_legacy_name("L223.SectorLogitTables_USAelec[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L223.SectorLogitTables_USAelec[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
...
tibble() %>%
 ...
 add_comments("comments describing how data generated") %>%
 add_comments("can be multiple lines") %>%
 add_legacy_name("L223.SubsectorLogitTables_USAelec[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L223.SubsectorLogitTables_USAelec[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
...
tibble() %>%
 ...
 add_comments("comments describing how data generated") %>%
 add_comments("can be multiple lines") %>%
 add_legacy_name("L223.SectorLogitTables_elec_FERC[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L223.SectorLogitTables_elec_FERC[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
...
tibble() %>%
 ...
 add_comments("comments describing how data generated") %>%
 add_comments("can be multiple lines") %>%
 add_legacy_name("L223.SubsectorLogitTables_elec_FERC[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L223.SubsectorLogitTables_elec_FERC[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
 ...
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L223.StubTechCapFactor_elec_solar_USA
    ...
    return_data(L223.DeleteSubsector_USAelec, L223.SectorNodeEquiv, L223.TechNodeEquiv, L223.PassThroughSector_elec, L223.PassThroughTech_elec_FERC, object, L223.SectorLogitTables_USAelec[[ curr_table ]]$data, L223.Supplysector_USAelec, L223.SubsectorShrwtFllt_USAelec, L223.SubsectorInterp_USAelec, L223.SubsectorLogitTables_USAelec[[ curr_table ]]$data, L223.SubsectorLogit_USAelec, L223.TechShrwt_USAelec, L223.TechCoef_USAelec, L223.Production_USAelec, L223.SectorLogitTables_elec_FERC[[ curr_table ]]$data, L223.Supplysector_elec_FERC, L223.SubsectorShrwtFllt_elec_FERC, L223.SubsectorInterp_elec_FERC, L223.SubsectorLogitTables_elec_FERC[[ curr_table ]]$data, L223.SubsectorLogit_elec_FERC, L223.TechShrwt_elec_FERC, L223.TechCoef_elec_FERC, L223.Production_elec_FERC, L223.InterestRate_FERC, L223.Pop_FERC, L223.BaseGDP_FERC, L223.LaborForceFillout_FERC, L223.SubsectorShrwt_nuc_USA, L223.StubTechFixOut_elec_USA, L223.StubTechFixOut_hydro_USA, L223.StubTechProd_elec_USA, L223.StubTechMarket_elec_USA, L223.StubTechMarket_backup_USA, L223.StubTechElecMarket_backup_USA, L223.StubTechCapFactor_elec_wind_USA, L223.StubTechCapFactor_elec_solar_USA)
  } else {
