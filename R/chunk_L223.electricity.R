...
#' the generated outputs: \code{L223.SectorLogitTables[[ curr_table ]]$data}, \code{L223.Supplysector_elec}, \code{L223.ElecReserve}, \code{L223.SubsectorLogitTables[[ curr_table ]]$data}, \code{L223.SubsectorLogit_elec}, \code{L223.SubsectorShrwt_elec}, \code{L223.SubsectorShrwtFllt_elec}, \code{L223.SubsectorShrwt_nuc}, \code{L223.SubsectorShrwt_renew}, \code{L223.SubsectorInterp_elec}, \code{L223.SubsectorInterpTo_elec}, \code{L223.StubTech_elec}, \code{L223.GlobalIntTechEff_elec}, \code{L223.GlobalTechEff_elec}, \code{L223.GlobalTechCapital_elec}, \code{L223.GlobalIntTechCapital_elec}, \code{L223.GlobalTechOMfixed_elec}, \code{L223.GlobalIntTechOMfixed_elec}, \code{L223.GlobalTechOMvar_elec}, \code{L223.GlobalIntTechOMvar_elec}, \code{L223.GlobalTechShrwt_elec}, \code{L223.GlobalTechInterp_elec}, \code{L223.GlobalIntTechShrwt_elec}, \code{L223.PrimaryRenewKeyword_elec}, \code{L223.PrimaryRenewKeywordInt_elec}, \code{L223.AvgFossilEffKeyword_elec}, \code{L223.GlobalTechCapture_elec}, \code{L223.GlobalIntTechBackup_elec}, \code{L223.StubTechCapFactor_elec}, \code{L223.GlobalTechShutdown_elec}, \code{L223.GlobalIntTechShutdown_elec}, \code{L223.GlobalTechSCurve_elec}, \code{L223.GlobalIntTechSCurve_elec}, \code{L223.GlobalTechLifetime_elec}, \code{L223.GlobalIntTechLifetime_elec}, \code{L223.GlobalTechProfitShutdown_elec}, \code{L223.GlobalIntTechProfitShutdown_elec}, \code{L223.StubTechCalInput_elec}, \code{L223.StubTechFixOut_elec}, \code{L223.StubTechFixOut_hydro}, \code{L223.StubTechProd_elec}, \code{L223.StubTechEff_elec}, \code{L223.GlobalTechCapital_sol_adv}, \code{L223.GlobalIntTechCapital_sol_adv}, \code{L223.GlobalTechCapital_wind_adv}, \code{L223.GlobalIntTechCapital_wind_adv}, \code{L223.GlobalTechCapital_geo_adv}, \code{L223.GlobalTechCapital_nuc_adv}, \code{L223.GlobalTechCapital_sol_low}, \code{L223.GlobalIntTechCapital_sol_low}, \code{L223.GlobalTechCapital_wind_low}, \code{L223.GlobalIntTechCapital_wind_low}, \code{L223.GlobalTechCapital_geo_low}, \code{L223.GlobalTechCapital_nuc_low}, \code{L223.GlobalTechCapital_bio_low}. The corresponding file in the
...
#' @export
module_energy_L223.electricity_DISABLED <- function(command, ...) {
...
FILE = "energy/A23.globaltech_co2capture",
 ...
 "L102.gdp_mil90usd_GCAM3_ctry_Y"))
    ...
    return(c(XML = "L223.SectorLogitTables[[ curr_table ]]$data",
XML = "L223.Supplysector_elec",
XML = "L223.ElecReserve",
XML = "L223.SubsectorLogitTables[[ curr_table ]]$data",
XML = "L223.SubsectorLogit_elec",
XML = "L223.SubsectorShrwt_elec",
XML = "L223.SubsectorShrwtFllt_elec",
XML = "L223.SubsectorShrwt_nuc",
XML = "L223.SubsectorShrwt_renew",
XML = "L223.SubsectorInterp_elec",
XML = "L223.SubsectorInterpTo_elec",
XML = "L223.StubTech_elec",
XML = "L223.GlobalIntTechEff_elec",
XML = "L223.GlobalTechEff_elec",
XML = "L223.GlobalTechCapital_elec",
XML = "L223.GlobalIntTechCapital_elec",
XML = "L223.GlobalTechOMfixed_elec",
XML = "L223.GlobalIntTechOMfixed_elec",
XML = "L223.GlobalTechOMvar_elec",
XML = "L223.GlobalIntTechOMvar_elec",
XML = "L223.GlobalTechShrwt_elec",
XML = "L223.GlobalTechInterp_elec",
XML = "L223.GlobalIntTechShrwt_elec",
XML = "L223.PrimaryRenewKeyword_elec",
XML = "L223.PrimaryRenewKeywordInt_elec",
XML = "L223.AvgFossilEffKeyword_elec",
XML = "L223.GlobalTechCapture_elec",
XML = "L223.GlobalIntTechBackup_elec",
XML = "L223.StubTechCapFactor_elec",
XML = "L223.GlobalTechShutdown_elec",
XML = "L223.GlobalIntTechShutdown_elec",
XML = "L223.GlobalTechSCurve_elec",
XML = "L223.GlobalIntTechSCurve_elec",
XML = "L223.GlobalTechLifetime_elec",
XML = "L223.GlobalIntTechLifetime_elec",
XML = "L223.GlobalTechProfitShutdown_elec",
XML = "L223.GlobalIntTechProfitShutdown_elec",
XML = "L223.StubTechCalInput_elec",
XML = "L223.StubTechFixOut_elec",
XML = "L223.StubTechFixOut_hydro",
XML = "L223.StubTechProd_elec",
XML = "L223.StubTechEff_elec",
XML = "L223.GlobalTechCapital_sol_adv",
XML = "L223.GlobalIntTechCapital_sol_adv",
XML = "L223.GlobalTechCapital_wind_adv",
XML = "L223.GlobalIntTechCapital_wind_adv",
XML = "L223.GlobalTechCapital_geo_adv",
XML = "L223.GlobalTechCapital_nuc_adv",
XML = "L223.GlobalTechCapital_sol_low",
XML = "L223.GlobalIntTechCapital_sol_low",
XML = "L223.GlobalTechCapital_wind_low",
XML = "L223.GlobalIntTechCapital_wind_low",
XML = "L223.GlobalTechCapital_geo_low",
XML = "L223.GlobalTechCapital_nuc_low",
XML = "L223.GlobalTechCapital_bio_low"))
 ...
 add_legacy_name("L223.SectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L223.SectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
...
tibble() %>%
 ...
 add_comments("comments describing how data generated") %>%
 add_comments("can be multiple lines") %>%
 add_legacy_name("L223.SubsectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L223.SubsectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
