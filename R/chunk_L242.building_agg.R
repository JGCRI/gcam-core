...
FILE = "energy/A42.demand",
 ...
 "L142.in_EJ_R_bld_F_Yh"))
    ...
    return(c(XML = "L242.SectorLogitTables[[ curr_table ]]$data",
XML = "L242.Supplysector_bld",
XML = "L242.FinalEnergyKeyword_bld",
XML = "L242.SubsectorLogitTables[[ curr_table ]]$data",
XML = "L242.SubsectorLogit_bld",
XML = "L242.SubsectorShrwt_bld",
XML = "L242.SubsectorShrwtFllt_bld",
XML = "L242.SubsectorInterp_bld",
XML = "L242.SubsectorInterpTo_bld",
XML = "L242.StubTech_bld",
XML = "L242.GlobalTechInterp_bld",
XML = "L242.GlobalTechShrwt_bld",
XML = "L242.GlobalTechEff_bld",
XML = "L242.GlobalTechCost_bld",
XML = "L242.StubTechCalInput_bld",
XML = "L242.FuelPrefElast_bld",
XML = "L242.PerCapitaBased_bld",
XML = "L242.PriceElasticity_bld",
XML = "L242.BaseService_bld"))
 ...
 add_legacy_name("L242.SectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L242.SectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
...
tibble() %>%
 ...
 add_comments("comments describing how data generated") %>%
 add_comments("can be multiple lines") %>%
 add_legacy_name("L242.SubsectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L242.SubsectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
 ...
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L242.BaseService_bld
    ...
    return_data(L242.SectorLogitTables[[ curr_table ]]$data, L242.Supplysector_bld, L242.FinalEnergyKeyword_bld, L242.SubsectorLogitTables[[ curr_table ]]$data, L242.SubsectorLogit_bld, L242.SubsectorShrwt_bld, L242.SubsectorShrwtFllt_bld, L242.SubsectorInterp_bld, L242.SubsectorInterpTo_bld, L242.StubTech_bld, L242.GlobalTechInterp_bld, L242.GlobalTechShrwt_bld, L242.GlobalTechEff_bld, L242.GlobalTechCost_bld, L242.StubTechCalInput_bld, L242.FuelPrefElast_bld, L242.PerCapitaBased_bld, L242.PriceElasticity_bld, L242.BaseService_bld)
  } else {
