...
FILE = "socioeconomics/A32.inc_elas_output",
 ...
 "L102.pcgdp_thous90USD_Scen_R_Y"))
    ...
    return(c(XML = "L232.SectorLogitTables[[ curr_table ]]$data",
XML = "L232.Supplysector_ind",
XML = "L232.SubsectorLogitTables[[ curr_table ]]$data",
XML = "L232.SubsectorLogit_ind",
XML = "L232.FinalEnergyKeyword_ind",
XML = "L232.SubsectorShrwt_ind",
XML = "L232.SubsectorShrwtFllt_ind",
XML = "L232.SubsectorInterp_ind",
XML = "L232.SubsectorInterpTo_ind",
XML = "L232.StubTech_ind",
XML = "L232.GlobalTechShrwt_ind",
XML = "L232.StubTechInterp_ind",
XML = "L232.GlobalTechEff_ind",
XML = "L232.GlobalTechCoef_ind",
XML = "L232.GlobalTechCost_ind",
XML = "L232.GlobalTechSecOut_ind",
XML = "L232.GlobalTechCSeq_ind",
XML = "L232.StubTechCalInput_indenergy",
XML = "L232.StubTechCalInput_indfeed",
XML = "L232.StubTechProd_industry",
XML = "L232.StubTechCoef_industry",
XML = "L232.FuelPrefElast_indenergy",
XML = "L232.PerCapitaBased_ind",
XML = "L232.PriceElasticity_ind",
XML = "L232.BaseService_ind",
XML = "object"))
 ...
 add_legacy_name("L232.SectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L232.SectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
...
tibble() %>%
 ...
 add_comments("comments describing how data generated") %>%
 add_comments("can be multiple lines") %>%
 add_legacy_name("L232.SubsectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L232.SubsectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
 ...
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   object
    ...
    return_data(L232.SectorLogitTables[[ curr_table ]]$data, L232.Supplysector_ind, L232.SubsectorLogitTables[[ curr_table ]]$data, L232.SubsectorLogit_ind, L232.FinalEnergyKeyword_ind, L232.SubsectorShrwt_ind, L232.SubsectorShrwtFllt_ind, L232.SubsectorInterp_ind, L232.SubsectorInterpTo_ind, L232.StubTech_ind, L232.GlobalTechShrwt_ind, L232.StubTechInterp_ind, L232.GlobalTechEff_ind, L232.GlobalTechCoef_ind, L232.GlobalTechCost_ind, L232.GlobalTechSecOut_ind, L232.GlobalTechCSeq_ind, L232.StubTechCalInput_indenergy, L232.StubTechCalInput_indfeed, L232.StubTechProd_industry, L232.StubTechCoef_industry, L232.FuelPrefElast_indenergy, L232.PerCapitaBased_ind, L232.PriceElasticity_ind, L232.BaseService_ind, object)
  } else {
