...
#' @export
module_energy_LA100.IEA_downscale_ctry_DISABLED <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    return(c( "L100.Pop_thous_ctry_Yh",
FILE = "energy/en_OECD",
FILE = "energy/en_nonOECD",
FILE = "energy/IEA_product_downscaling",
FILE = "energy/IEA_ctry"))
  ...
  IEA_product_downscaling <- get_data(all_data, "energy/IEA_product_downscaling")
