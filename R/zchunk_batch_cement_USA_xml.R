...
module_gcamusa_batch_cement_USA_xml_DISABLED <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    create_xml("cement_USA.xml") %>%
      ...
      add_precursors("L210.DeleteUnlimitRsrc_USAlimestone", "L210.UnlimitRsrc_limestone_USA", "L210.UnlimitRsrcPrice_limestone_USA", "L2321.DeleteSupplysector_USAcement", "L2321.DeleteFinalDemand_USAcement", "object", "L2321.StubTechProd_cement_USA", "L2321.StubTechCoef_cement_USA", "L2321.StubTechCalInput_cement_heat_USA", "L2321.StubTechMarket_cement_USA", "L2321.BaseService_cement_USA") ->
      cement_USA.xml
