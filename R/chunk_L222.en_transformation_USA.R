...
FILE = "energy/calibrated_techs",
 ...
 "L202.CarbonCoef"))
    ...
    return(c(XML = "L222.DeleteStubTech_USAen",
XML = "L222.SectorEQUIV",
XML = "L222.PassThroughSector_USAen",
XML = "object",
XML = "L222.TechEQUIV",
XML = "L222.Tech_USAen",
XML = "L222.TechShrwt_USAen",
XML = "L222.TechInterp_USAen",
XML = "L222.TechShrwt_USAen",
XML = "L222.TechCoef_USAen",
XML = "L222.Production_USArefining",
XML = "L222.SectorLogitTables_USA[[ curr_table ]]$data",
XML = "L222.Supplysector_en_USA",
XML = "L222.SubsectorShrwtFllt_en_USA",
XML = "L222.StubTechProd_refining_USA",
XML = "L222.StubTechMarket_en_USA",
XML = "L222.CarbonCoef_en_USA"))
...
tibble() %>%
 ...
 add_comments("comments describing how data generated") %>%
 add_comments("can be multiple lines") %>%
 add_legacy_name("L222.SectorLogitTables_USA[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L222.SectorLogitTables_USA[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
 ...
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L222.CarbonCoef_en_USA
    ...
    return_data(L222.DeleteStubTech_USAen, L222.SectorEQUIV, L222.PassThroughSector_USAen, object, L222.TechEQUIV, L222.Tech_USAen, L222.TechShrwt_USAen, L222.TechInterp_USAen, L222.TechShrwt_USAen, L222.TechCoef_USAen, L222.Production_USArefining, L222.SectorLogitTables_USA[[ curr_table ]]$data, L222.Supplysector_en_USA, L222.SubsectorShrwtFllt_en_USA, L222.StubTechProd_refining_USA, L222.StubTechMarket_en_USA, L222.CarbonCoef_en_USA)
  } else {
