...
FILE = "energy/A322.globaltech_coef",
 ...
 "L1322.out_Mt_state_Fert_Yh"))
    ...
    return(c(XML = "L2322.DeleteSubsector_USAFert",
XML = "object",
XML = "L2322.FinalEnergyKeyword_USAFert",
XML = "L2322.SubsectorLogitTables_USAFert[[ curr_table ]]$data",
XML = "L2322.SubsectorLogit_USAFert",
XML = "L2322.SubsectorShrwtFllt_USAFert",
XML = "L2322.SubsectorInterp_USAFert",
XML = "L2322.TechShrwt_USAFert",
XML = "L2322.Production_USAFert",
XML = "L2322.TechCoef_USAFert",
XML = "L2322.StubTechProd_Fert_USA",
XML = "L2322.StubTechCoef_Fert_USA",
XML = "L2322.StubTechMarket_Fert_USA"))
...
tibble() %>%
 ...
 add_comments("comments describing how data generated") %>%
 add_comments("can be multiple lines") %>%
 add_legacy_name("L2322.SubsectorLogitTables_USAFert[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L2322.SubsectorLogitTables_USAFert[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
 ...
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L2322.StubTechMarket_Fert_USA
    ...
    return_data(L2322.DeleteSubsector_USAFert, object, L2322.FinalEnergyKeyword_USAFert, L2322.SubsectorLogitTables_USAFert[[ curr_table ]]$data, L2322.SubsectorLogit_USAFert, L2322.SubsectorShrwtFllt_USAFert, L2322.SubsectorInterp_USAFert, L2322.TechShrwt_USAFert, L2322.Production_USAFert, L2322.TechCoef_USAFert, L2322.StubTechProd_Fert_USA, L2322.StubTechCoef_Fert_USA, L2322.StubTechMarket_Fert_USA)
  } else {
