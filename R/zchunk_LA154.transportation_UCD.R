...
module_energy_LA154.transportation_UCD <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    IEA_hist_data_times_UCD_shares_region_scaled_to_enduse_data %>%
      ...
      add_precursors("common/iso_GCAM_regID", "temp-data-inject/L101.in_EJ_ctry_trn_Fi_Yh",
                     "temp-data-inject/L1011.in_EJ_ctry_intlship_TOT_Yh", "L131.in_EJ_R_Senduse_F_Yh",
    ...
    IEA_hist_data_times_UCD_shares %>%
      ...
      add_precursors("common/iso_GCAM_regID", "temp-data-inject/L101.in_EJ_ctry_trn_Fi_Yh",
                     paste0("energy/UCD_trn_data_", energy.TRN_SSP), "energy/mappings/calibrated_techs_trn_agg",
                     "energy/mappings/UCD_ctry", "energy/mappings/UCD_techs",
    ...
    PKM_nonmotor_GCAM_R %>%
      ...
      add_precursors("common/iso_GCAM_regID", "energy/mappings/UCD_ctry",paste0("energy/UCD_trn_data_", energy.TRN_SSP),
                     "L100.Pop_thous_ctry_Yh") %>%
      add_flags(FLAG_LONG_YEAR_FORM, FLAG_NO_XYEAR) ->
      L154.out_mpkm_R_trn_nonmotor_Yh
