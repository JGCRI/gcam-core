...
FILE = "gcam-usa/NREL_us_re_technical_potential",
 ...
 "L210.GrdRenewRsrcMax_geo"))
    ...
    return(c(XML = "L210.DeleteRenewRsrc_USArsrc",
XML = "L210.DeleteUnlimitRsrc_USArsrc",
XML = "L210.RenewRsrc_USA",
XML = "L210.UnlimitRsrc_USA",
XML = "L210.UnlimitRsrcPrice_USA",
XML = "L210.SmthRenewRsrcTechChange_USA",
XML = "L210.SmthRenewRsrcCurves_wind_USA",
XML = "L210.GrdRenewRsrcCurves_geo_USA",
XML = "L210.GrdRenewRsrcMax_geo_USA",
XML = "L210.SmthRenewRsrcCurvesGdpElastCapFac_roofPV_USA",
XML = "L210.DeleteUnlimitRsrc_USAlimestone",
XML = "L210.UnlimitRsrc_limestone_USA",
XML = "L210.UnlimitRsrcPrice_limestone_USA"))
