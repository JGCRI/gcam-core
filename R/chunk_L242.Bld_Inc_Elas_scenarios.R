...
#' @export
module_socioeconomics_L242.Bld_Inc_Elas_scenarios_DISABLED <- function(command, ...) {
...
FILE = "socioeconomics/A42.inc_elas",
 ...
 "L102.pcgdp_thous90USD_Scen_R_Y"))
    ...
    return(c(XML = "L242.IncomeElasticity_bld_GCAM3",
XML = "object"))
 ...
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   object
    ...
    return_data(L242.IncomeElasticity_bld_GCAM3, object)
  } else {
