...
#' Country-level supply curves were generated using data from Zhou. Every country within a region shared the
#' the same price points for which to calculate supply. The minimum price was determined to be the lowest base price
#' within that region. Maximum prices was calculated to be the price where supply is 95% that of the available resource.
#' The highest maximum price within the region was then used. The rest of the price points were filled out in equal increments.
