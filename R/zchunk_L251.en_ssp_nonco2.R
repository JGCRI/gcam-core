...
module_emissions_L251.en_ssp_nonco2_DISABLED <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L161.SSP2_EF <- get_data(all_data, "temp-data-inject/L161.SSP2_EF")
    L161.SSP15_EF <- get_data(all_data, "temp-data-inject/L161.SSP15_EF")
    L161.SSP34_EF <- get_data(all_data, "temp-data-inject/L161.SSP34_EF")
    L201.nonghg_steepness <- get_data(all_data, "temp-data-inject/L201.nonghg_steepness")
