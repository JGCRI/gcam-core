#' module_aglu_batch_protected_land_input_2.xml
#'
...
module_aglu_batch_protected_land_input_2.xml_DISABLED <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    create_xml("protected_land_input_2.xml") %>%
      ...
      add_precursors("L222.LN2_HistUnmgdAllocation_noprot", "L222.LN2_UnmgdAllocation_noprot", "L222.LN2_UnmgdCarbon", "L222.LN1_HistUnmgdAllocation_prot", "L222.LN1_UnmgdAllocation_prot", "L222.LN1_UnmgdCarbon_prot") ->
