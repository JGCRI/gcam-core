...
FILE = "aglu/A_agSupplySubsector",
 ...
 "L132.ag_an_For_Prices"))
    ...
    return(c(XML = "L201.AgSectorLogitTables[[ curr_table ]]$data",
XML = "L201.AgSupplySector",
XML = "L201.AgSubsectorLogitTables[[ curr_table ]]$data",
XML = "L201.AgSupplySubsector",
XML = "L201.AgProduction_ag",
XML = "L201.AgProduction_For",
XML = "L201.AgProduction_Past",
XML = "L201.AgHAtoCL",
XML = "L201.AgYield_bio_grass",
XML = "L201.AgYield_bio_tree"))
