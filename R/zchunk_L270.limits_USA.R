...
#' the generated outputs: \code{L270.CreditMkt_USA},  \code{paste0( "L270.NegEmissBudget_USA_", c("GCAM3", paste0("SSP", 1:5), paste0("gSSP", 1:5), c("spa1", "spa23", "spa4", "spa5")) )}.
...
module_gcam.usa_L270.limits_USA <- function(command, ...) {
  negative_emiss_input_names <- paste0( "L270.NegEmissBudget_", c("GCAM3", paste0("SSP", 1:5), paste0("gSSP", 1:5), c("spa1", "spa23", "spa4", "spa5")) )
