...
#'
#' This chunck is to generate (water demand) technology coefficient for each GCAM region for base years and future years.
#'
...
#' @details This chunck is to generate (water demand) technology coefficient for each GCAM region for base years and future years,
