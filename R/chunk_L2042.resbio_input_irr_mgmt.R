...
module_aglu_L2042.resbio_input_irr_mgmt_DISABLED <- function(command, ...) {
 ...
 "L2041.AgResBioCurve_ag_irr"))
    ...
    return(c(XML = "L2042.AgResBio_For",
XML = "L2042.AgResBioCurve_For",
XML = "L2042.GlobalResBio_Mill",
XML = "L2042.StubResBioCurve_Mill",
XML = "L2042.AgResBio_ag_irr_mgmt",
XML = "L2042.AgResBioCurve_ag_irr_mgmt"))
