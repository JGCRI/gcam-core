...
FILE = "aglu/A_agSupplySector",
 ...
 "L2011.AgYield_bio_tree_irr"))
    ...
    return(c(XML = "L2012.AgSectorLogitTables[[ curr_table ]]$data",
XML = "L2012.AgSupplySector",
XML = "L2012.AgSubsectorLogitTables[[ curr_table ]]$data",
XML = "L2012.AgSupplySubsector",
XML = "L2012.AgProduction_ag_irr_mgmt",
XML = "L2012.AgProduction_For",
XML = "L2012.AgProduction_Past",
XML = "L2012.AgHAtoCL_irr_mgmt",
XML = "L2012.AgYield_bio_ref"))
 ...
 add_legacy_name("L2012.AgSectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L2012.AgSectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
 ...
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L2012.AgYield_bio_ref
    ...
    return_data(L2012.AgSectorLogitTables[[ curr_table ]]$data, L2012.AgSupplySector, L2012.AgSubsectorLogitTables[[ curr_table ]]$data, L2012.AgSupplySubsector, L2012.AgProduction_ag_irr_mgmt, L2012.AgProduction_For, L2012.AgProduction_Past, L2012.AgHAtoCL_irr_mgmt, L2012.AgYield_bio_ref)
  } else {
