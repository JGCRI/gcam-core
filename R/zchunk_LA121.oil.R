...
module_energy_LA121.oil <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L121.in_EJ_R_unoil_F_Yh %>%
      ...
      add_precursors("L111.Prod_EJ_R_F_Yh", "energy/A21.globaltech_coef", "energy/calibrated_techs") %>%
    ...
    L121.in_EJ_R_TPES_unoil_Yh %>%
      ...
      add_precursors("L111.Prod_EJ_R_F_Yh", "energy/A21.unoil_demandshares", "L100.IEA_en_bal_ctry_hist", "common/iso_GCAM_regID", "energy/mappings/IEA_product_rsrc") %>%
      add_flags(FLAG_LONG_YEAR_FORM, FLAG_NO_XYEAR) ->
      L121.in_EJ_R_TPES_unoil_Yh
