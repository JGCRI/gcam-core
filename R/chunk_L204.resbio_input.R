...
FILE = "aglu/A_bio_frac_prod_R",
 ...
 "L123.For_Prod_bm3_R_Y_GLU"))
    ...
    return(c(XML = "L204.AgResBio_For",
XML = "L204.GlobalResBio_Mill",
XML = "L204.AgResBio_ag",
XML = "L204.AgResBioCurve_For",
XML = "L204.StubResBioCurve_Mill",
XML = "L204.AgResBioCurve_ag"))
