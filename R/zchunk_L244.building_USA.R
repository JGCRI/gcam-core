...
module_gcam.usa_L244.building_USA <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L244.Supplysector_bld_gcamusa <- write_to_all_states(A44.sector, c(LEVEL2_DATA_NAMES[["Supplysector"]], LOGIT_COLUMN_NAME))
    ...
    L244.SubsectorLogit_bld_gcamusa <- write_to_all_states(A44.subsector_logit, c(LEVEL2_DATA_NAMES[["SubsectorLogit"]], LOGIT_COLUMN_NAME))
