...
FILE = "aglu/A_an_input_subsector",
 ...
 "L132.ag_an_For_Prices"))
    ...
    return(c(XML = "L221.SectorLogitTables[[ curr_table ]]$data",
XML = "L221.Supplysector_en",
XML = "L221.SectorUseTrialMarket_en",
XML = "L221.SubsectorLogitTables[[ curr_table ]]$data",
XML = "L221.SubsectorLogit_en",
XML = "L221.SubsectorShrwt_en",
XML = "L221.SubsectorShrwtFllt_en",
XML = "L221.SubsectorInterp_en",
XML = "L221.SubsectorInterpTo_en",
XML = "L221.StubTech_en",
XML = "L221.GlobalTechCoef_en",
XML = "L221.GlobalTechCost_en",
XML = "L221.GlobalTechShrwt_en",
XML = "L221.PrimaryConsKeyword_en",
XML = "L221.StubTechFractSecOut_en",
XML = "L221.StubTechFractProd_en",
XML = "L221.DepRsrc_en",
XML = "L221.DepRsrcPrice_en",
XML = "L221.TechCoef_en_Traded",
XML = "L221.TechCost_en_Traded",
XML = "L221.TechShrwt_en_Traded",
XML = "L221.StubTechCoef_unoil",
XML = "L221.Production_unoil",
XML = "L221.StubTechProd_oil_unoil",
XML = "L221.StubTechProd_oil_crude",
XML = "L221.StubTechShrwt_bio"))
 ...
 add_legacy_name("L221.SectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L221.SectorLogitTables[[ curr_table ]]$data
tibble() %>%
   add_title("descriptive title of data") %>%
 add_units("units") %>%
 add_comments("comments describing how data generated") %>%
...
tibble() %>%
 ...
 add_comments("comments describing how data generated") %>%
 add_comments("can be multiple lines") %>%
 add_legacy_name("L221.SubsectorLogitTables[[ curr_table ]]$data") %>%
 add_precursors("precursor1", "precursor2", "etc") %>%
 # typical flags, but there are others--see `constants.R` 
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
 ...
 add_flags(FLAG_NO_TEST) %>%
  add_xml_data() ->
   L221.StubTechShrwt_bio
    ...
    return_data(L221.SectorLogitTables[[ curr_table ]]$data, L221.Supplysector_en, L221.SectorUseTrialMarket_en, L221.SubsectorLogitTables[[ curr_table ]]$data, L221.SubsectorLogit_en, L221.SubsectorShrwt_en, L221.SubsectorShrwtFllt_en, L221.SubsectorInterp_en, L221.SubsectorInterpTo_en, L221.StubTech_en, L221.GlobalTechCoef_en, L221.GlobalTechCost_en, L221.GlobalTechShrwt_en, L221.PrimaryConsKeyword_en, L221.StubTechFractSecOut_en, L221.StubTechFractProd_en, L221.DepRsrc_en, L221.DepRsrcPrice_en, L221.TechCoef_en_Traded, L221.TechCost_en_Traded, L221.TechShrwt_en_Traded, L221.StubTechCoef_unoil, L221.Production_unoil, L221.StubTechProd_oil_unoil, L221.StubTechProd_oil_crude, L221.StubTechShrwt_bio)
  } else {
