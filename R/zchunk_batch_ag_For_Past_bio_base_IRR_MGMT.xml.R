...
module_aglu_batch_ag_For_Past_bio_base_IRR_MGMT.xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    create_xml("ag_For_Past_bio_base_IRR_MGMT.xml") %>%
      ...
      add_precursors("L2012.AgSupplySector", "L2012.AgSupplySubsector", "L2012.AgProduction_ag_irr_mgmt", "L2012.AgProduction_For", "L2012.AgProduction_Past", "L2012.AgHAtoCL_irr_mgmt", "L2012.AgYield_bio_ref") ->
