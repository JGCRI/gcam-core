...
module_gcam.usa_L232.industry_USA <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    return(c(FILE = "gcam-usa/states_subregions",
             ...
             FILE = "temp-data-inject/L232.Supplysector_ind",
             FILE = "temp-data-inject/L232.StubTech_ind",
             FILE = "temp-data-inject/L232.PerCapitaBased_ind",
    ...
    L232.Supplysector_ind <- get_data(all_data, "temp-data-inject/L232.Supplysector_ind")
    L232.StubTech_ind <- get_data(all_data, "temp-data-inject/L232.StubTech_ind")
    L232.PerCapitaBased_ind <- get_data(all_data, "temp-data-inject/L232.PerCapitaBased_ind")
    ...
    L232.DeleteSupplysector_USAind %>%
      ...
      add_precursors("temp-data-inject/L232.Supplysector_ind") ->
      L232.DeleteSupplysector_USAind
    ...
    L232.DeleteFinalDemand_USAind %>%
      ...
      add_precursors("temp-data-inject/L232.PerCapitaBased_ind") ->
      L232.DeleteFinalDemand_USAind
