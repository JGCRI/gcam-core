...
generate_level2_data_names <- function() {
  ...
  level2_data_names[["SupplysectorLogitType"]] <- c("region", "supplysector", LOGIT_COLUMN_NAME)
  level2_data_names[["Supplysector_absolute-cost-logit"]] <- c("region", "supplysector", LOGIT_COLUMN_NAME)
  level2_data_names[["Supplysector_relative-cost-logit"]] <- c("region", "supplysector", LOGIT_COLUMN_NAME)
  ...
  level2_data_names[["SubsectorLogitType"]] <- c(level2_data_names[["Subsector"]], LOGIT_COLUMN_NAME)
  level2_data_names[["SubsectorLogit_absolute-cost-logit"]] <- c("region", "supplysector", "subsector", LOGIT_COLUMN_NAME)
  level2_data_names[["SubsectorLogit_relative-cost-logit"]] <- c("region", "supplysector", "subsector", LOGIT_COLUMN_NAME)
  ...
  level2_data_names[["tranSubsector_absolute-cost-logit"]] <- c("region", "supplysector", "tranSubsector", LOGIT_COLUMN_NAME)
  level2_data_names[["tranSubsector_relative-cost-logit"]] <- c("region", "supplysector", "tranSubsector", LOGIT_COLUMN_NAME)
  ...
  level2_data_names[["AgSupplySectorLogitType"]] <- c("region", "AgSupplySector", LOGIT_COLUMN_NAME)
  level2_data_names[["AgSupplySector_absolute-cost-logit"]] <- c("region", "AgSupplySector", LOGIT_COLUMN_NAME)
  level2_data_names[["AgSupplySector_relative-cost-logit"]] <- c("region", "AgSupplySector", LOGIT_COLUMN_NAME)
  level2_data_names[["AgSupplySubsector"]] <- c("region", "AgSupplySector", "AgSupplySubsector", "logit.year.fillout", "logit.exponent")
  level2_data_names[["AgSupplySubsectorLogitType"]] <- c("region", "AgSupplySector", "AgSupplySubsector", LOGIT_COLUMN_NAME)
  level2_data_names[["AgSupplySubsector_absolute-cost-logit"]] <- c("region", "AgSupplySector", "AgSupplySubsector", LOGIT_COLUMN_NAME)
  level2_data_names[["AgSupplySubsector_relative-cost-logit"]] <- c("region", "AgSupplySector", "AgSupplySubsector", LOGIT_COLUMN_NAME)
  ...
  level2_data_names[["LN0_LogitType"]] <- c("region", "LandAllocatorRoot", LOGIT_COLUMN_NAME)
  level2_data_names[["LN0_Logit_absolute-cost-logit"]] <- c("region", "LandAllocatorRoot", LOGIT_COLUMN_NAME)
  level2_data_names[["LN0_Logit_relative-cost-logit"]] <- c("region", "LandAllocatorRoot", LOGIT_COLUMN_NAME)
  ...
  level2_data_names[["LN1_LogitType"]] <- c("region", "LandAllocatorRoot", "LandNode1", LOGIT_COLUMN_NAME)
  level2_data_names[["LN1_Logit_absolute-cost-logit"]] <- c("region", "LandAllocatorRoot", "LandNode1", LOGIT_COLUMN_NAME)
  level2_data_names[["LN1_Logit_relative-cost-logit"]] <- c("region", "LandAllocatorRoot", "LandNode1", LOGIT_COLUMN_NAME)
  ...
  level2_data_names[["LN2_LogitType"]] <- c("region", "LandAllocatorRoot", "LandNode1", "LandNode2", LOGIT_COLUMN_NAME)
  level2_data_names[["LN2_Logit_absolute-cost-logit"]] <- c("region", "LandAllocatorRoot", "LandNode1", "LandNode2", LOGIT_COLUMN_NAME)
  level2_data_names[["LN2_Logit_relative-cost-logit"]] <- c("region", "LandAllocatorRoot", "LandNode1", "LandNode2", LOGIT_COLUMN_NAME)
  ...
  level2_data_names[["LN3_LogitType"]] <- c("region", "LandAllocatorRoot", "LandNode1", "LandNode2", "LandNode3", LOGIT_COLUMN_NAME)
  level2_data_names[["LN3_Logit_absolute-cost-logit"]] <- c("region", "LandAllocatorRoot", "LandNode1", "LandNode2", "LandNode3", LOGIT_COLUMN_NAME)
  level2_data_names[["LN3_Logit_relative-cost-logit"]] <- c("region", "LandAllocatorRoot", "LandNode1", "LandNode2", "LandNode3", LOGIT_COLUMN_NAME)
  ...
  level2_data_names[["LN4_LogitType"]] <- c("region", "LandAllocatorRoot", "LandNode1", "LandNode2", "LandNode3", "LandNode4", LOGIT_COLUMN_NAME)
  level2_data_names[["LN4_Logit_absolute-cost-logit"]] <- c("region", "LandAllocatorRoot", "LandNode1", "LandNode2", "LandNode3", "LandNode4", LOGIT_COLUMN_NAME)
  level2_data_names[["LN4_Logit_relative-cost-logit"]] <- c("region", "LandAllocatorRoot", "LandNode1", "LandNode2", "LandNode3", "LandNode4", LOGIT_COLUMN_NAME)
  ...
  level2_data_names[["LN5_LogitType"]] <- c("region", "LandAllocatorRoot", "LandNode1", "LandNode2", "LandNode3", "LandNode4", "LandNode5", LOGIT_COLUMN_NAME)
  level2_data_names[["LN5_Logit_absolute-cost-logit"]] <- c("region", "LandAllocatorRoot", "LandNode1", "LandNode2", "LandNode3", "LandNode4", "LandNode5", LOGIT_COLUMN_NAME)
  level2_data_names[["LN5_Logit_relative-cost-logit"]] <- c("region", "LandAllocatorRoot", "LandNode1", "LandNode2", "LandNode3", "LandNode4", "LandNode5", LOGIT_COLUMN_NAME)
