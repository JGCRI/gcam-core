...
/*! 
 * \file price_less_than_solution_info_filter.cpp
 * \ingroup Objects
 * \brief PriceLessThanSolutionInfoFilter class source file.
 * \author Pralit Patel
 */
...
const string& PriceLessThanSolutionInfoFilter::getXMLNameStatic() {
    const static string XML_NAME = "price-less-than-solution-info-filter";
    return XML_NAME;
}
