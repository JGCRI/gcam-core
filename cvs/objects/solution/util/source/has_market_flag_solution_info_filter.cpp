...
/*! 
 * \file has_market_flag_solution_info_filter.cpp
 * \ingroup Objects
 * \brief HasMarketFlagSolutionInfoFilter class source file.
 * \author Pralit Patel
 */
...
bool HasMarketFlagSolutionInfoFilter::acceptSolutionInfo( const SolutionInfo& aSolutionInfo ) const {
    /*!
     * \pre mMarketInfoKey was read in.
     */
    assert( !mMarketInfoKey.empty() );
    return aSolutionInfo.getMarketInfo()->getBoolean( mMarketInfoKey, false );
}
