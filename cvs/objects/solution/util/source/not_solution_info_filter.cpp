...
/*! 
 * \file not_solution_info_filter.cpp
 * \ingroup Objects
 * \brief NotSolutionInfoFilter class source file.
 * \author Pralit Patel
 */
...
bool NotSolutionInfoFilter::acceptSolutionInfo( const SolutionInfo& aSolutionInfo ) const {
    // return the opposite of the wrapped filter
    return !mWrappedFilter->acceptSolutionInfo( aSolutionInfo );
}
