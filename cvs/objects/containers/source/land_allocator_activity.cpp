...
/*! 
 * \file land_allocator_activity.cpp
 * \ingroup Objects
 * \brief The LandAllocatorActivity class source file.
 * \author Pralit Patel
 */
...
LandAllocatorActivity::~LandAllocatorActivity() {
    // Note that this object does not own any memory
}

void LandAllocatorActivity::calc( const int aPeriod ) {
