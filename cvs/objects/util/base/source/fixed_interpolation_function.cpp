...
/*! 
 * \file fixed_interpolation_function.cpp
 * \ingroup Objects
 * \brief FixedInterpolationFunction class source file.
 * \author Pralit Patel
 */
...
bool FixedInterpolationFunction::XMLParse( const DOMNode* aNode ) {
...
{
    // this function is fixed at the value for the left data point
    return aLeftPoint->getY();
}
