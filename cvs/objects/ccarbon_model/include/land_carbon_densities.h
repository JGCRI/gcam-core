...
protected:
    ...
    DEFINE_DATA_WITH_PARENT(
        ...
        DEFINE_VARIABLE( SIMPLE | STATE, "above-ground-carbon-density", mAvgAboveGroundCarbon, Value ),
        
        //! Average below ground carbon content (read in).
        DEFINE_VARIABLE( SIMPLE | STATE, "below-ground-carbon-density", mAvgBelowGroundCarbon, Value ),
