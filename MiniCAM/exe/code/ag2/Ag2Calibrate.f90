...
REAL(8) Factor, CropArea(NL), ManLand(NL), UnmanLand(NL), yieldratio(NL)
...
REAL(8) AdjSD(NL,3), proffactor(NL,3), shareland0(NL,2), shareland1(NL,3), &
	shareland2(NL,5), profperout0(NL,1), profperout1(NL,2), profperout2(NL,5), &
	profperha0(NL,2), profperha1(NL,3), profperha2(NL,5), othcostperout1(NL,3), &
	priceperout1(NL,4), avgyield1(NL,2), avgyield2(NL,5), &
...
REAL(8) avgyield1(NL,2),avgyield2(NL,5),fyield(NL)
