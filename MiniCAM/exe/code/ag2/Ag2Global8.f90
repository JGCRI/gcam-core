...
INTEGER,PARAMETER :: NLP=14,NMP=9,NUMAX=100,NZMAX=12,MAXFILES=20
REAL(8),PARAMETER :: InterestR=0.0200d0, STEP=15.0d0
...
deforEnergy(NLP,NMP),       & ! Energy context of deforested biomass (as used)
