...
module_gcamusa_L132.industry <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    # This part replicates the calculations that take place in module_energy_L132.industry, with subsequent deductions
    ...
    # Part 1a - deductions
    # See module_energy_L132.industry for explanations of each flow that contributes to these deductions; for the most
