...
module_energy_L2325.chemical <- function(command, ...) {
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    A325.sector <- get_data(all_data, "energy/A325.sector")
    A325.subsector_interp <- get_data(all_data, "energy/A325.subsector_interp")
    A325.subsector_logit <- get_data(all_data, "energy/A325.subsector_logit")
    A325.subsector_shrwt <- get_data(all_data, "energy/A325.subsector_shrwt")
    A325.globaltech_coef <- get_data(all_data, "energy/A325.globaltech_coef")
    A325.globaltech_eff <- get_data(all_data, "energy/A325.globaltech_eff")
    A325.globaltech_co2capture <- get_data(all_data, "energy/A325.globaltech_co2capture")
    A325.globaltech_cost <- get_data(all_data, "energy/A325.globaltech_cost")
	  A325.globaltech_retirement <- get_data(all_data, "energy/A325.globaltech_retirement")
	  A325.nonenergy_Cseq <- get_data(all_data, "energy/A325.nonenergy_Cseq")
    A325.globaltech_shrwt <- get_data(all_data, "energy/A325.globaltech_shrwt")
    A325.demand <- get_data(all_data, "energy/A325.demand")
