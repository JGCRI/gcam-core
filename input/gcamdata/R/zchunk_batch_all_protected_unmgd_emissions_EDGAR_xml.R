...
#'
#' Construct XML data structure for \code{all_protected_unmgd_emissions.xml} for EDGAR emissions.
#'
...
module_emissions_batch_all_protected_unmgd_emissions_edgar_xml <- function(command, ...) {
