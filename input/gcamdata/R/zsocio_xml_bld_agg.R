...
module_socio_bld_agg_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    return_data(bld_agg_SSP1.xml, bld_agg_SSP2.xml, bld_agg_SSP3.xml, bld_agg_SSP4.xml, bld_agg_SSP5.xml)
