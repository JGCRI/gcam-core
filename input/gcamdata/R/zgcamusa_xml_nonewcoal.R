...
module_gcamusa_nonewcoal_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L2231.SubsectorShrwt_nonewcoal_elecS_cool_USA <- get_data(all_data, "L2231.SubsectorShrwt_nonewcoal_elecS_cool_USA")
