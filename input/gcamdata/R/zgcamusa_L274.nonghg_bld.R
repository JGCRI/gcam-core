...
#' module_gcamusa_L274.nonghg_bld
#'
...
module_gcamusa_L274.nonghg_bld <- function(command, ...) {
if(command == driver.DECLARE_INPUTS) {
  ...
  L274.nonghg_bld_tech_coeff_Yb_USA.noBCOC <- replace_outlier_EFs(L274.nonghg_bld_tech_coeff_Yb_USA.NAs, to_group, names, ef_col_name)
