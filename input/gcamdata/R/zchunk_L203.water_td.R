...
module_water_L203.water_td <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L110.in_km3_water_primary <- get_data(all_data, "L110.in_km3_water_primary")
    L1233.wdraw_km3_R_elec <- get_data(all_data, "L1233.wdraw_km3_R_elec")
    L1233.wcons_km3_R_elec <- get_data(all_data, "L1233.wcons_km3_R_elec")
    ...
    L171.share_R_desal_basin <- get_data(all_data, "L171.share_R_desal_basin")
