...
module_energy_batch_aluminum_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    #    L2326.SubsectorShrwt_aluminum <- get_data(all_data, "L2326.SubsectorShrwt_aluminum")
    ...
    #    L2326.SubsectorInterpTo_aluminum <- get_data(all_data, "L2326.SubsectorInterpTo_aluminum")
    ...
    create_xml("aluminum.xml") %>%
      ...
      #add_xml_data(L2326.SubsectorShrwt_aluminum, "SubsectorShrwt") %>%
      ...
      #add_xml_data(L2326.SubsectorInterpTo_aluminum, "SubsectorInterpTo") %>%
