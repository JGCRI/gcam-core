...
module_energy_L2326.aluminum <- function(command, ...) {
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    A326.sector <- get_data(all_data, "energy/A326.sector")
    A326.subsector_interp <- get_data(all_data, "energy/A326.subsector_interp")
    A326.subsector_logit <- get_data(all_data, "energy/A326.subsector_logit")
    A326.subsector_shrwt <- get_data(all_data, "energy/A326.subsector_shrwt")
    A326.globaltech_coef <- get_data(all_data, "energy/A326.globaltech_coef")
    A326.globaltech_co2capture <- get_data(all_data, "energy/A326.globaltech_co2capture")
	A326.globaltech_retirement <- get_data(all_data, "energy/A326.globaltech_retirement")
    A326.globaltech_cost <- get_data(all_data, "energy/A326.globaltech_cost")
    A326.globaltech_shrwt <- get_data(all_data, "energy/A326.globaltech_shrwt")
    A326.demand <- get_data(all_data, "energy/A326.demand")
