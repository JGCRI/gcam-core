#' module_gcam.india_L201.socioeconomics_INDIA
#'
...
module_gcam.india_L201.socioeconomics_INDIA <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L201.InterestRate <- tibble(region = States_Subregions_Grid$state, interest.rate = socioeconomics.DEFAULT_INTEREST_RATE)
    ...
    L201.LaborForceFillout <- tibble(region = States_Subregions_Grid$state,
    ...
    L201.InterestRate %>%
      ...
      add_precursors("gcam-india/States_Subregions_Grid") ->
