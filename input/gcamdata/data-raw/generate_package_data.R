...
generate_level2_data_names <- function() {
  ...
  level2_data_names[["StubTechInterp_NC"]] <- c(level2_data_names[["StubTech"]], "apply.to", "from.year", "to.year", "interpolation.function")
  level2_data_names[["StubTechShrwt"]] <- c("region", "supplysector", "subsector", "stub.technology", "year", "share.weight")
  level2_data_names[["StubTechShrwt_NC"]] <- c("region", "supplysector", "subsector", "stub.technology", "year", "share.weight")
