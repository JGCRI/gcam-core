...
generate_level2_data_names <- function() {
  ...
  level2_data_names[["ThermalServiceAdder"]] <- c("region", "gcam.consumer", "nodeInput", "building.node.input", "thermal.building.service.input", "bias.adder")
  ...
  level2_data_names[["GenericServiceAdder"]] <- c("region", "gcam.consumer", "nodeInput", "building.node.input", "building.service.input", "bias.adder")
