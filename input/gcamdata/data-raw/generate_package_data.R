...
generate_level2_data_names <- function() {
  ...
  level2_data_names[["Gomp.fn.param"]] <- c("region","gcam.consumer","nodeInput","building.node.input","habitable-land","base-pcFlsp","unadjust-satiation","land-density-param","base-floorspace-param","income-param","bias-adjust-param")
