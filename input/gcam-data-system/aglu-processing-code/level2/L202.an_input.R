...
L202.UnlimitedRenewRsrcCurves <- write_to_all_regions_ag( A_agUnlimitedRsrcCurves, names_UnlimitRsrc )
...
L202.UnlimitedRenewRsrcPrice <- write_to_all_regions_ag( L202.UnlimitedRenewRsrcPrice, names_UnlimitRsrcPrice )
