...
A_an_input_technology_R <- write_to_all_regions( A_an_input_technology, c( names_Tech, "minicam.energy.input", "market.name" ) )
...
L241.ag_kcalg_R_C_Yf.melt <- subset( L241.ag_kcalg_R_C_Y.melt, year == max( aglu_demand_calyears ) )
