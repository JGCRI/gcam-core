...
L162.ag_YieldRate_R_C_Y_GLU_irr <- readdata( "AGLU_LEVEL1_DATA", "L162.ag_YieldRate_R_C_Y_GLU_irr" )
L162.bio_YieldRate_R_Y_GLU_irr <- readdata( "AGLU_LEVEL1_DATA", "L162.bio_YieldRate_R_Y_GLU_irr" )
L163.ag_irrBioYield_GJm2_R_GLU <- readdata( "AGLU_LEVEL1_DATA", "L163.ag_irrBioYield_GJm2_R_GLU" )
L163.ag_rfdBioYield_GJm2_R_GLU <- readdata( "AGLU_LEVEL1_DATA", "L163.ag_rfdBioYield_GJm2_R_GLU" )
