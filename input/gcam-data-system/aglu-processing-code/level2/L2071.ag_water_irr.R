...
L161.ag_irrYield_kgm2_R_C_Y_GLU <- readdata( "AGLU_LEVEL1_DATA", "L161.ag_irrYield_kgm2_R_C_Y_GLU" )
L165.BlueIrr_m3kg_R_C_GLU <- readdata( "AGLU_LEVEL1_DATA", "L165.BlueIrr_m3kg_R_C_GLU" )
L165.TotIrr_m3kg_R_C_GLU <- readdata( "AGLU_LEVEL1_DATA", "L165.TotIrr_m3kg_R_C_GLU" )
L165.GreenRfd_m3kg_R_C_GLU <- readdata( "AGLU_LEVEL1_DATA", "L165.GreenRfd_m3kg_R_C_GLU" )
...
do_water_rename <- function(d) {
  ...
  d[[GLU]] <- as.integer( sub( '.*GLU', '', d[[agsubs]] ) )
