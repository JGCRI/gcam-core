 ...
 * \details This class runs a scenario multiple times.  It reads in two emissions curves
 ...
 *                      - \c type PointSetCurve
 *                      - \c name upper-bound
 *                      - \c wre wre level of curve (this has no function, for reference only)
 *                  -Elements:
 *                      - \c PointSet
 *                          -Attributes
 *                              - \c type ExplicitPointSet
 *                          -Elements
 *                              - \c DataPoint (there can be a datapoint for each period)
 *                                  -Attributes
 *                                      - \c type XYDataPoint
 *                                  -Elements
 *                                      - \c x x point
