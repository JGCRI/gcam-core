...
*          stores this information in a pair of lists. The first list contains
...
private:
    ...
    */
    ...
    private:
        ...
        //! A list of Good nodes.
        mutable GoodList mGoodList;

        //! The region or market area name.
        const std::string mName;
    };
    /*! \brief A list of RegionOrMarketNodes which can be searched quickly to
    *          find a particular region or market.
    ...
    */
    ...
    private:
        //! The last RegionNode found in a lookup.
        mutable RegionOrMarketNode* mCachedPosition;

        //! A list of RegionOrMarket nodes.
        std::vector<RegionOrMarketNode*> mList;
    };

    //! A list of market areas.
    std::auto_ptr<RegionOrMarketList> mMarketList;

    //! A list of regions.
    std::auto_ptr<RegionOrMarketList> mRegionOrMarketList;
};
