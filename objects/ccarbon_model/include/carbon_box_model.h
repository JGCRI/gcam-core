...
private:
    ...
    //! Vector of pointers to CarbonBoxes.
    std::vector<CarbonBox*> mCarbonBoxes;
    //! EnvironmentalInfo object that contains the parameters for the equations.
    ...
    void printGraphOneFile( const std::string& fileName,
                            const int aPeriod ) const;
    void checkForDuplicateName( std::string aName ) const;
