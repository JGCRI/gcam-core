...
void GDP::MCoutput( const string& regionName ) const {
   ...
   dboutput4( regionName, "General", "Labor Prod", "GrowthRate", "per yr", temp );	
    ...
    // write gdp and adjusted gdp for region
    dboutput4(regionName,"General","GDP 90$","GDP(90mer)","Mil90US$", gdpValueAdjusted );
    dboutput4(regionName,"General","GDP 90$","GDP(90ppp)","Mil90US$", gdpValueAdjustedPPP );
    dboutput4(regionName,"General","GDP 90$","GDP Aprox(90mer)","Mil90US$", gdpValue );
    dboutput4(regionName,"General","GDP","per cap","thousand90US$", gdpPerCapita );
}
