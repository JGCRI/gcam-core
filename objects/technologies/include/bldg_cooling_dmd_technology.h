#ifndef _BLDG_COOLING_DMD_TECHNOLOGY_H_
#define _BLDG_COOLING_DMD_TECHNOLOGY_H_
#if defined(_MSC_VER)
#pragma once
#endif
...
class BuildingCoolingDmdTechnology : public BuildingDmdTechnology
{
public:
    BuildingCoolingDmdTechnology(); // default construtor
    BuildingCoolingDmdTechnology& operator=( const BuildingCoolingDmdTechnology& techIn ); // assignment operator.
    virtual BuildingCoolingDmdTechnology* clone() const;
    virtual ~BuildingCoolingDmdTechnology();
...
#endif // _BLDG_COOLING_DMD_TECHNOLOGY_H_
