...
public:
    ...
    * \author Steve Smith
    * \return The average observed rate for this land allocator for calibration.
    */
    ...
    */
    ...
    /*! \brief Apply agricultural productivity change to the land associated with a product.
