...
L151.min_coeff <- melt( A51.min_coeff, id.vars=c( "supplysector", "subsector", "stub.technology" ) )
...
L151.nonghg_ctrl_R_en_S_T <- melt( L111.nonghg_tgej_R_en_S_F_Yh, id.vars=c( "GCAM_region_ID", "supplysector", "subsector", "stub.technology", "Non.CO2" ))
L151.nonghg_ctrl_R_en_S_T <- subset( L151.nonghg_ctrl_R_en_S_T, L151.nonghg_ctrl_R_en_S_T$variable == "X2005" )
names( L151.nonghg_ctrl_R_en_S_T )[ names( L151.nonghg_ctrl_R_en_S_T ) == "value" ] <- "curr_coeff"
L151.nonghg_ctrl_R_en_S_T$min_coeff <- L151.min_coeff$value[ match( vecpaste(L151.nonghg_ctrl_R_en_S_T[ c( "supplysector", "subsector", "stub.technology", "Non.CO2" ) ] ), vecpaste( L151.min_coeff[ c( "supplysector", "subsector", "stub.technology", "variable" )] ) ) ]
L151.nonghg_ctrl_R_en_S_T <- na.omit( L151.nonghg_ctrl_R_en_S_T )

#Finally, compute maximum reduction as percentage
L151.nonghg_ctrl_R_en_S_T$max_reduction <- 100 * ( L151.nonghg_ctrl_R_en_S_T$curr_coeff - L151.nonghg_ctrl_R_en_S_T$min_coeff ) / L151.nonghg_ctrl_R_en_S_T$curr_coeff
L151.nonghg_ctrl_R_en_S_T <- na.omit( L151.nonghg_ctrl_R_en_S_T )
...
L151.bcoc_ctrl_R_en_S_T$variable <- "X2000"
names( L151.bcoc_ctrl_R_en_S_T )[ names( L151.bcoc_ctrl_R_en_S_T ) == "X2000" ] <- "curr_coeff"
L151.bcoc_ctrl_R_en_S_T$min_coeff <- L151.min_coeff$value[ match( vecpaste(L151.bcoc_ctrl_R_en_S_T[ c( "supplysector", "subsector", "stub.technology", "Non.CO2" ) ] ), vecpaste( L151.min_coeff[ c( "supplysector", "subsector", "stub.technology", "variable" )] ) ) ]
L151.bcoc_ctrl_R_en_S_T <- na.omit( L151.bcoc_ctrl_R_en_S_T )

#Finally, compute maximum reduction as percentage
L151.bcoc_ctrl_R_en_S_T$max_reduction <- 100 * ( L151.bcoc_ctrl_R_en_S_T$curr_coeff - L151.bcoc_ctrl_R_en_S_T$min_coeff ) / L151.bcoc_ctrl_R_en_S_T$curr_coeff
L151.bcoc_ctrl_R_en_S_T <- na.omit( L151.bcoc_ctrl_R_en_S_T )
L151.bcoc_ctrl_R_en_S_T$max_reduction[ L151.bcoc_ctrl_R_en_S_T$max_reduction == "-Inf" ] <- 0
...
L151.nonghg_ctrl_R_en_S_T <- L151.nonghg_ctrl_R_en_S_T[ names( L151.nonghg_ctrl_R_en_S_T ) %!in% c( "curr_coeff", "min_coeff", "variable" )]
