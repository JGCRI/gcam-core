...
write_mi_data( L213.Sector, "SectorUnmgd", "EMISSIONS_LEVEL2_DATA", "L213.Sector", "EMISSIONS_XML_BATCH", "batch_protected_unmgd_emissions.xml" ) 
write_mi_data( L213.LandItem, "ItemNameUnmgd", "EMISSIONS_LEVEL2_DATA", "L213.LandItem", "EMISSIONS_XML_BATCH", "batch_protected_unmgd_emissions.xml" ) 
write_mi_data( L213.LandItemProtect, "ItemNameUnmgd", "EMISSIONS_LEVEL2_DATA", "L213.LandItemProtect", "EMISSIONS_XML_BATCH", "batch_protected_unmgd_emissions.xml" ) 
write_mi_data( L213.GRASSEmissions, "InputEmissionsUnmgd", "EMISSIONS_LEVEL2_DATA", "L213.GRASSEmissions", "EMISSIONS_XML_BATCH", "batch_protected_unmgd_emissions.xml" ) 
write_mi_data( L213.FORESTEmissions, "InputEmissionsUnmgd", "EMISSIONS_LEVEL2_DATA", "L213.FORESTEmissions", "EMISSIONS_XML_BATCH", "batch_protected_unmgd_emissions.xml" ) 
write_mi_data( L213.GRASSEmissionsFactors, "InputEmFactUnmgd", "EMISSIONS_LEVEL2_DATA", "L213.GRASSEmissionsFactors", "EMISSIONS_XML_BATCH", "batch_protected_unmgd_emissions.xml" ) 
write_mi_data( L213.FORESTEmissionsFactors, "InputEmFactUnmgd", "EMISSIONS_LEVEL2_DATA", "L213.FORESTEmissionsFactors", "EMISSIONS_XML_BATCH", "batch_protected_unmgd_emissions.xml" ) 
write_mi_data( L213.GRASSEmissionsProtect, "InputEmissionsUnmgd", "EMISSIONS_LEVEL2_DATA", "L213.GRASSEmissionsProtect", "EMISSIONS_XML_BATCH", "batch_protected_unmgd_emissions.xml" ) 
write_mi_data( L213.FORESTEmissionsProtect, "InputEmissionsUnmgd", "EMISSIONS_LEVEL2_DATA", "L213.FORESTEmissionsProtect", "EMISSIONS_XML_BATCH", "batch_protected_unmgd_emissions.xml" ) 
write_mi_data( L213.GRASSEmissionsFactorsProtect, "InputEmFactUnmgd", "EMISSIONS_LEVEL2_DATA", "L213.GRASSEmissionsFactorsProtect", "EMISSIONS_XML_BATCH", "batch_protected_unmgd_emissions.xml" ) 
write_mi_data( L213.FORESTEmissionsFactorsProtect, "InputEmFactUnmgd", "EMISSIONS_LEVEL2_DATA", "L213.FORESTEmissionsFactorsProtect", "EMISSIONS_XML_BATCH", "batch_protected_unmgd_emissions.xml" ) 

insert_file_into_batchxml( "EMISSIONS_XML_BATCH", "batch_protected_unmgd_emissions.xml", "EMISSIONS_XML_FINAL", "all_protected_unmgd_emissions.xml", "", xml_tag="outFile" )
