...
write_mi_data( L211.AWBEmissions, "OutputEmissionsAg", "EMISSIONS_LEVEL2_DATA", "L211.awb_emissions", "EMISSIONS_XML_BATCH", "batch_ag_emissions.xml" ) 
write_mi_data( L211.AGREmissions, "OutputEmissionsAg", "EMISSIONS_LEVEL2_DATA", "L211.agr_emissions", "EMISSIONS_XML_BATCH", "batch_ag_emissions.xml" ) 
write_mi_data( L211.AnEmissions, "OutputEmissions", "EMISSIONS_LEVEL2_DATA", "L211.an_emissions", "EMISSIONS_XML_BATCH", "batch_ag_emissions.xml" ) 
write_mi_data( L211.AnNH3Emissions, "OutputEmissions", "EMISSIONS_LEVEL2_DATA", "L211.an_nh3_emissions", "EMISSIONS_XML_BATCH", "batch_ag_emissions.xml" ) 
write_mi_data( L211.AGRBio, "OutputEmissCoeffAg", "EMISSIONS_LEVEL2_DATA", "L211.bio_emissions", "EMISSIONS_XML_BATCH", "batch_ag_emissions.xml" ) 
write_mi_data( L211.AWB_BCOC_Emissions, "OutputEmissCoeffAg", "EMISSIONS_LEVEL2_DATA", "L211.awb_bcoc_emissions", "EMISSIONS_XML_BATCH", "batch_ag_emissions.xml" ) 
write_mi_data( L211.nonghg_max_reduction, "AgGDPCtrlMax", "EMISSIONS_LEVEL2_DATA", "L211.nonco2_max_reduction", "EMISSIONS_XML_BATCH", "batch_ag_emissions.xml" ) 
write_mi_data( L211.nonghg_steepness, "AgGDPCtrlSteep", "EMISSIONS_LEVEL2_DATA", "L211.nonco2_steepness", "EMISSIONS_XML_BATCH", "batch_ag_emissions.xml" ) 
