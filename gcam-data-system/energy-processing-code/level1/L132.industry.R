...
#Combine all of the deduction tables and aggregate
...
L132.in_EJ_R_inddeductions_F_Yh <- aggregate( L132.in_EJ_R_inddeductions_F_Yh[ X_historical_years ], by=as.list( L132.in_EJ_R_inddeductions_F_Yh[ R_F ] ), sum )
...
L132.in_EJ_R_indenergy_F_Yh[ L132.in_EJ_R_indenergy_F_Yh$fuel %in% L132.in_EJ_R_inddeductions_F_Yh$fuel, X_historical_years ] <-
      L132.in_EJ_R_indenergy_F_Yh[ L132.in_EJ_R_indenergy_F_Yh$fuel %in% L132.in_EJ_R_inddeductions_F_Yh$fuel, X_historical_years ] - 
      L132.in_EJ_R_inddeductions_F_Yh[ X_historical_years ]
