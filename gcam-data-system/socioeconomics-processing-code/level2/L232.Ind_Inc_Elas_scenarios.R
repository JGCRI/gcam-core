...
write_mi_data( L232.IncomeElasticity_ind_GCAM3, "IncomeElasticity", "SOCIO_LEVEL2_DATA", "L232.IncomeElasticity_ind_GCAM3", "SOCIO_XML_BATCH", "batch_industry_GCAM3.xml" ) 
write_mi_data( L232.IncomeElasticity_ind_SSP1, "IncomeElasticity", "SOCIO_LEVEL2_DATA", "L232.IncomeElasticity_ind_SSP1", "SOCIO_XML_BATCH", "batch_industry_SSP1.xml" ) 
write_mi_data( L232.IncomeElasticity_ind_SSP2, "IncomeElasticity", "SOCIO_LEVEL2_DATA", "L232.IncomeElasticity_ind_SSP2", "SOCIO_XML_BATCH", "batch_industry_SSP2.xml" ) 
write_mi_data( L232.IncomeElasticity_ind_SSP3, "IncomeElasticity", "SOCIO_LEVEL2_DATA", "L232.IncomeElasticity_ind_SSP3", "SOCIO_XML_BATCH", "batch_industry_SSP3.xml" ) 
write_mi_data( L232.IncomeElasticity_ind_SSP4, "IncomeElasticity", "SOCIO_LEVEL2_DATA", "L232.IncomeElasticity_ind_SSP4", "SOCIO_XML_BATCH", "batch_industry_SSP4.xml" ) 
write_mi_data( L232.IncomeElasticity_ind_SSP5, "IncomeElasticity", "SOCIO_LEVEL2_DATA", "L232.IncomeElasticity_ind_SSP5", "SOCIO_XML_BATCH", "batch_industry_SSP5.xml" ) 

insert_file_into_batchxml( "SOCIO_XML_BATCH", "batch_industry_GCAM3.xml", "SOCIO_XML_FINAL", "industry_GCAM3.xml", "", xml_tag="outFile" )
insert_file_into_batchxml( "SOCIO_XML_BATCH", "batch_industry_SSP1.xml", "SOCIO_XML_FINAL", "industry_SSP1.xml", "", xml_tag="outFile" )
insert_file_into_batchxml( "SOCIO_XML_BATCH", "batch_industry_SSP2.xml", "SOCIO_XML_FINAL", "industry_SSP2.xml", "", xml_tag="outFile" )
insert_file_into_batchxml( "SOCIO_XML_BATCH", "batch_industry_SSP3.xml", "SOCIO_XML_FINAL", "industry_SSP3.xml", "", xml_tag="outFile" )
insert_file_into_batchxml( "SOCIO_XML_BATCH", "batch_industry_SSP4.xml", "SOCIO_XML_FINAL", "industry_SSP4.xml", "", xml_tag="outFile" )
insert_file_into_batchxml( "SOCIO_XML_BATCH", "batch_industry_SSP5.xml", "SOCIO_XML_FINAL", "industry_SSP5.xml", "", xml_tag="outFile" )
