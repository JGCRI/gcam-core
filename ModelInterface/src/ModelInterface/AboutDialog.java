...
public class AboutDialog extends JDialog implements MenuAdder, ActionListener {
     ...
     */
	public static final String LICENSE_TEXT = "<html><body>LEGAL NOTICE<br>This computer software was prepared by Battelle Memorial Institute,<br>hereinafter the Contractor, under Contract No. DE-AC05-76RL0 1830<br>with the Department of Energy (DOE). NEITHER THE GOVERNMENT NOR THE<br>CONTRACTOR MAKES ANY WARRANTY, EXPRESS OR IMPLIED, OR ASSUMES ANY<br>LIABILITY FOR THE USE OF THIS SOFTWARE. This notice including this<br>sentence must appear on any copies of this computer software.<br><br>Copyright 2011 Battelle Memorial Institute.  All Rights Reserved.<br>Distributed as open-source under the terms of the Educational Community <br>License version 2.0 (ECL 2.0). http://www.opensource.org/licenses/ecl2.php<br><br>EXPORT CONTROL<br>User agrees that the Software will not be shipped, transferred or<br>exported into any country or used in any manner prohibited by the<br>United States Export Administration Act or any other applicable<br>export laws, restrictions or regulations (collectively the \"Export Laws\").<br>Export of the Software may require some form of license or other<br>authority from the U.S. Government, and failure to obtain such<br>export control license may result in criminal liability under<br>U.S. laws. In addition, if the Software is identified as export controlled<br>items under the Export Laws, User represents and warrants that User<br>is not a citizen, or otherwise located within, an embargoed nation<br>(including without limitation Iran, Syria, Sudan, Cuba, and North Korea)<br>and that User is not otherwise prohibited<br>under the Export Laws from receiving the Software.<br></body></html>";
