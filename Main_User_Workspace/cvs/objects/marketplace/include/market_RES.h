#ifndef _MARKET_RES_H_
#define _MARKET_RES_H_
...
* \file market_RES.h
* \ingroup Objects
* \brief The MarketRES class header file.
* \author Sonny Kim
*/
...
/*!
* \ingroup Objects
* \brief A class which defines a MarketRES object which is used for Renewable Energy
* \standards (like biofuels in transportation or electric RPS's)
* \and perhaps other intensity targets where the target is a percentage
* \of a total needs to be provided by a certain type of resource or fuel.
* \author MW
*/
