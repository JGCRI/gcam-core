...
if( exists( "L254.tranSubsectorShrwtFllt" ) ){
	write_mi_data( L254.tranSubsectorShrwtFllt, "tranSubsectorShrwtFllt", "ENERGY_LEVEL2_DATA", "L254.tranSubsectorShrwtFllt",
	               "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" ) 
	}
if( exists( "L254.tranSubsectorInterp" ) ) {
	write_mi_data( L254.tranSubsectorInterp, "tranSubsectorInterp", "ENERGY_LEVEL2_DATA", "L254.tranSubsectorInterp", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
	}
if( exists( "L254.tranSubsectorInterpTo" ) ) {
	write_mi_data( L254.tranSubsectorInterpTo, "tranSubsectorInterpTo", "ENERGY_LEVEL2_DATA", "L254.tranSubsectorInterpTo", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
	}
write_mi_data( L254.tranSubsectorSpeed, "tranSubsectorSpeed", "ENERGY_LEVEL2_DATA", "L254.tranSubsectorSpeed", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.tranSubsectorSpeed_passthru, "tranSubsectorSpeed", "ENERGY_LEVEL2_DATA", "L254.tranSubsectorSpeed_passthru", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.tranSubsectorSpeed_noVOTT, "tranSubsectorSpeed", "ENERGY_LEVEL2_DATA", "L254.tranSubsectorSpeed_noVOTT", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.tranSubsectorSpeed_nonmotor, "tranSubsectorSpeed", "ENERGY_LEVEL2_DATA", "L254.tranSubsectorSpeed_nonmotor", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.tranSubsectorVOTT, "tranSubsectorVOTT", "ENERGY_LEVEL2_DATA", "L254.tranSubsectorVOTT", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.tranSubsectorFuelPref, "tranSubsectorFuelPref", "ENERGY_LEVEL2_DATA", "L254.tranSubsectorFuelPref", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.StubTranTech, "StubTranTech", "ENERGY_LEVEL2_DATA", "L254.StubTranTech", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.StubTech_passthru, "StubTranTech", "ENERGY_LEVEL2_DATA", "L254.StubTech_passthru", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.StubTech_nonmotor, "StubTranTech", "ENERGY_LEVEL2_DATA", "L254.StubTech_nonmotor", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.GlobalTechShrwt_passthru, "GlobalTechShrwt", "ENERGY_LEVEL2_DATA", "L254.GlobalTechShrwt_passthru", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.GlobalTechShrwt_nonmotor, "GlobalTechShrwt", "ENERGY_LEVEL2_DATA", "L254.GlobalTechShrwt_nonmotor", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.GlobalTechCoef_passthru, "GlobalTechCoef", "ENERGY_LEVEL2_DATA", "L254.GlobalTechCoef_passthru", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.GlobalRenewTech_nonmotor, "GlobalRenewTech", "ENERGY_LEVEL2_DATA", "L254.GlobalRenewTech_nonmotor", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.GlobalTranTechInterp, "GlobalTranTechInterp", "ENERGY_LEVEL2_DATA", "L254.GlobalTranTechInterp", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.GlobalTranTechShrwt, "GlobalTranTechShrwt", "ENERGY_LEVEL2_DATA", "L254.GlobalTranTechShrwt", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.GlobalTranTechSCurve, "GlobalTranTechSCurve", "ENERGY_LEVEL2_DATA", "L254.GlobalTranTechSCurve", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.StubTranTechCalInput, "StubTranTechCalInput", "ENERGY_LEVEL2_DATA", "L254.StubTranTechCalInput", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.StubTranTechLoadFactor, "StubTranTechLoadFactor", "ENERGY_LEVEL2_DATA", "L254.StubTranTechLoadFactor", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.StubTranTechCost, "StubTranTechCost", "ENERGY_LEVEL2_DATA", "L254.StubTranTechCost", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.StubTranTechCoef, "StubTranTechCoef", "ENERGY_LEVEL2_DATA", "L254.StubTranTechCoef", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.StubTechCalInput_passthru, "StubTranTechCalInput", "ENERGY_LEVEL2_DATA", "L254.StubTechCalInput_passthru", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.StubTechProd_nonmotor, "StubTranTechProd", "ENERGY_LEVEL2_DATA", "L254.StubTechProd_nonmotor", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.PerCapitaBased_trn, "PerCapitaBased", "ENERGY_LEVEL2_DATA", "L254.PerCapitaBased_trn", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.PriceElasticity_trn, "PriceElasticity", "ENERGY_LEVEL2_DATA", "L254.PriceElasticity_trn", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.IncomeElasticity_trn, "IncomeElasticity", "ENERGY_LEVEL2_DATA", "L254.IncomeElasticity_trn", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )
write_mi_data( L254.BaseService_trn, "BaseService", "ENERGY_LEVEL2_DATA", "L254.BaseService_trn", "ENERGY_XML_BATCH", "batch_transportation_UCD.xml" )

insert_file_into_batchxml( "ENERGY_XML_BATCH", "batch_transportation_UCD.xml", "ENERGY_XML_FINAL", "transportation_UCD.xml", "", xml_tag="outFile" )
